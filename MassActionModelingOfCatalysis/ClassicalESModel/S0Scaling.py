...
for z in p:
    ...
    inletS = sol3[3]
    sol = odeint(func, y0, t, args=(k1,k01,k2,sol3[3] * 0))

    ax1 = fig.add_subplot(221)
    plt.plot(t, sol[:, 0])
    plt.xlabel('t')
    plt.ylabel('E')
    plt.title('           ES Dyanmics with S0 Scaling: S0 = 1000000k')
...
#fig.tight_layout()
pp = PdfPages('ClassicalESModelS0Scaling_1000000k.pdf')
pp.savefig(fig)
fig = plt.figure(2)
